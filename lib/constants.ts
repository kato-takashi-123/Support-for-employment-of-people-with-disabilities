...
export const FERTILIZERS = {
  'M-Plus-1': { name: '液肥 1', component: '窒素・リン酸・カリウム・微量要素', usage: '植物の基本的な生育に必要な三大栄養素と微量要素の補給', effect: '葉や茎を大きく育て、全体的な成長を促進します。葉の色が薄いとき（肥料切れのサイン）や、生育を旺盛にしたい成長過程に特に重要です。' },
  'M-Plus-2': { name: '液肥 2', component: 'カルシウム（硝酸カルシウムなど）', usage: '細胞を丈夫にするカルシウムの補給', effect: '細胞壁を強化し、根の張りや実の成長を助けます。トマトの尻腐れ病などのカルシウム欠乏症を防ぎ、病害虫への抵抗力を高める働きがあります。' },
};
